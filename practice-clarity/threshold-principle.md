...
intro: >
  ...
  they immediately begin asking whether they feel safe enough to stay.
  The Threshold Principle explores the first few seconds after arrival.
...
<nav class="acw-guide-breadcrumb" aria-label="Breadcrumb">
  ...
  <span>/</span>
  <strong>The Threshold Principle</strong>
</nav>
...
The first task of a therapist website is not to explain everything.

It is to help someone feel safe enough to keep reading.
...
The first few seconds after someone arrives on your website are not neutral.

They either reduce uncertainty or add to it.

A clear threshold helps people feel oriented, reassured and safe enough to stay.
...
<strong>Threshold clarity</strong>

At the point of arrival, the visitor needs three things before anything else:

- where they are
- who this is for
- what kind of help might be available

Everything else can unfold afterwards.
...
A good threshold does not push someone forward.

It makes the next step feel possible.
...
<figure class="acw-guide-figure">
  <img
    src="{{ '/assets/images/library/threshold-arrival.webp' | relative_url }}"
    alt="A quiet hallway with soft light through an open doorway, suggesting calm arrival."
    loading="lazy"
  >
</figure>
...
They are about helping them feel oriented, reassured and safe enough to continue.
...
When someone lands on your website, what do they understand within the first five seconds?
</div>

<div class="acw-callout acw-exercise">
Does your first screen reduce uncertainty, or does it ask the visitor to work things out?
</div>

<div class="acw-callout acw-exercise">
What does your website make someone feel before they have read very much?
</div>

<div class="acw-callout acw-exercise">
Is the next step clear without being pushy?
</div>
